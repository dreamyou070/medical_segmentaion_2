...
"""
A collection of generic interfaces for MONA transforms.
"""
...
class Transform(ABC):
    ...
    # Most of MONA transform's inputs and outputs will be converted into torch.Tensor or monai.data.MetaTensor.
