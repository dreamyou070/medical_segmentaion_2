...
"""
A collection of generic traits for MONA transforms.
"""
...
class LazyTrait:
    ...
    MONA's lazy resampling feature. In order to do this, the implementing class needs
    to be able to describe its operation as an affine matrix or grid with accompanying metadata.
    This interface can be extended from by people adapting transforms to the MONA framework as
    well as by implementors of MONA transforms.
    """
...
class RandomizableTrait:
    ...
    can be extended from by people adapting transforms to the MONA framework as well as by
    implementors of MONA transforms.
    """
...
class MultiSampleTrait:
    ...
    extended from by people adapting transforms to the MONA framework as well as by implementors
    of MONA transforms.
    """
