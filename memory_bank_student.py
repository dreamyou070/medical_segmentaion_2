...
def main(args):
    ...
    feature_file = r'/share0/dreamyou070/dreamyou070/MultiSegmentation/result/medical/leader_polyp/Pranet/up_16_32_64/31_pvt_image_encoder_with_position_embedder_memorybank/feature'
    feature_files = os.listdir(feature_file)
    features = []
    for feature in feature_files:
        feature_path = os.path.join(feature_file, feature)
        feature = torch.load(feature_path)
        features.append(feature)
    memory_bank = torch.stack(features) # number, feat_dim = 160
    ...
    for epoch in range(args.start_epoch, args.max_train_epochs):
        ...
        if is_main_process:
            ...
            save_model(args,
                       ...
                       unwrapped_nw=accelerator.unwrap_model(student_segmentation_head),
