...
def main(args):
    ...
    class simle_net(nn.Module):
        def __init__(self):
            ...
            self.mm_projector = nn.Sequential(nn.Linear(768, 3),)
    ...
    for epoch in range(args.start_epoch, args.max_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            image_feature = image_feature[:,1:, :]  # [batch, 576, 768
            encoder_hidden_states = simple_linear(image_feature) # [batch, 576, 3]

            pseudo_label = batch['pseudo_label']  # [batch, 3, 384, 384]
            print(f'encode_hidden_states = {encoder_hidden_states.shape}')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--use_pseudo_map", action='store_true')
