...
This is the repository for the [ADE20K Dataset](https://groups.csail.mit.edu/vision/datasets/ADE20K/). We provide some information of the dataset, and [starter code](notebooksde20k_starter.ipynb) to explore the data.
...
1. `image_name.jpg`: containing the raw image, with blurred license plates and faces (e.g. [ADE_train_00016869.jpg](datasetDE20K_2021_17_01/images/ADE/training/urban/street/ADE_train_00016869.jpg))
2. `image_name_seg.png`: with the pixel-wise annotations of objects and instances (e.g. [ADE_train_00016869_seg.png](datasetDE20K_2021_17_01/images/ADE/training/urban/street/ADE_train_00016869_seg.png)). The RGB channels encode the class and instance information. Check out (`utils/utils_ade20k.py`)[utils/utils_ade20k.py] for an example on how to read those.
...
We provide some [starter code](notebooksde20k_starter.ipynb) to analyze the dataset, basic statistics of the data and links to existing projects using ADE20K.
