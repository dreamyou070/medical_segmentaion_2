...
benchmark="Pranet_Sub2"
layer_name='layer_3'
sub_folder="up_16_32_64_20240501"
file_name="3_class_2_pvt_image_encoder" #
...
accelerate launch --config_file ../../gpu_config/gpu_0_1_config \
 ...
 --train_data_path "/home/dreamyou070/MyData/anomaly_detection/${category}/${obj_name}/${benchmark}/train/class_2" \
