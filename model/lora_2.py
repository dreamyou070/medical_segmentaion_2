...
def create_network_2(multiplier: float,
...
class LoRANetwork(torch.nn.Module):
    ...
    def apply_to(self, text_encoder, image_encoder, unet,
                 apply_image_encoder=True,
                 apply_text_encoder=True,
                 apply_unet=True):

        if apply_image_encoder:
        ...
        for lora in self.image_encoder_loras + self.text_encoder_loras + self.unet_loras:
            lora.apply_to()
