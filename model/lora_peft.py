...
from peft_origin import LoHaConfig, LoKrConfig, LoraConfig, PeftType, get_peft_model, set_peft_model_state_dict
from peft_origin.tuners.lokr.layer import factorization
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dump_path", default=None, type=str, required=True, help="Path to the output peft_origin adapter.")
    ...
    # Construct possible mapping from kohya keys to peft_origin keys
    models_keys = {}
    ...
    with safetensors.safe_open(args.adapter_path, framework="pt", device="cpu") as f:
        ...
        for key in f.keys():
            ...
            # Find corresponding peft_origin key
