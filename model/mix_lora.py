raise AttributeError("This file is a part of m-LoRA (mlora/common/mix_lora.py). Do not run it separately.")
...
class MixtralSparseMoe(torch.nn.Module):
    def __init__(self, args: LLMModelArgs, config: MixConfig) -> None:
        ...
        self.gate_ = torch.nn.Linear(args.dim_, config.num_experts_, bias=False, device=config.device, dtype=self.dtype_)
