...
def main(args):
    ...
    save_folder = os.path.join(args.output_dir, 'recon_image')
    ...
    unet, text_encoder, network, train_dataloader, test_dataloader, = \
                accelerator.prepare(unet, text_encoder, network, train_dataloader, test_dataloader)
