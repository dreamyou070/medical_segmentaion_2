...
# <br>
# This tutorial illustrates how to use MONA for 2D segmentation of images using DDPMs, as proposed in [1].<br>
...
#
# At this step, we instantiate the MONA components to create a DDPM, the UNET, the noise scheduler, and the inferer used for training and sampling. We are using the DDPM scheduler containing 1000 timesteps, and a 2D UNET with attention mechanisms in the 3rd level (`num_head_channels=64`).<br>
#
