...
#
# This tutorial illustrates how to use MONA Generative Models for training a 2D Diffusion Autoencoder model [1].
#
...
#
# At this step, we instantiate the MONA components to create a DDIM, the UNET with conditioning, the noise scheduler, and the inferer used for training and sampling. We are using
