...
#
# This tutorial illustrates how to use MONA for training a Vector Quantized Variational Autoencoder (VQVAE)[1] on 2D images.
#
# Here, we will train our VQVAE model to be able to reconstruct the input images.  We will work with the MedNIST dataset available on MONA
