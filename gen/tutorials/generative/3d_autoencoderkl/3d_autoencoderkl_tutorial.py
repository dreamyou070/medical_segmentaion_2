...
# # 3D AutoencoderKL
#
# This demo is a toy example of how to use MONA's AutoencoderKL. In particular, it uses the Autoencoder with a Kullback-Leibler regularisation as implemented by Rombach et. al [1].
#
...
#
# [Brain tumor 3D segmentation with MONA](https://github.com/Project-MONAI/tutorials/blob/main/3d_segmentation/brats_segmentation_3d.ipynb)
