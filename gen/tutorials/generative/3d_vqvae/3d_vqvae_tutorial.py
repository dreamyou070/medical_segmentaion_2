...
#
# This tutorial illustrates how to use MONA for training a Vector Quantized Variational Autoencoder (VQVAE)[1] on 3D images.
#
# Here, we will train our VQVAE model to be able to reconstruct the input images.  We will work with the Decathlon Dataset available on [MONA](https://docs.monai.io/en/stable/apps.html#monai.apps.DecathlonDataset). In order to train faster, we will select just one of the available tasks ("Task01_BrainTumour").
#
