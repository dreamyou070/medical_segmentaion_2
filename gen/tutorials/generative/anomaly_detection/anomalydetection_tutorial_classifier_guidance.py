...
#
# This tutorial illustrates how to use MONA for training a 2D gradient-guided anomaly detection using DDIMs [1].
#
...
# At this step, we instantiate the MONA components to create a DDIM, the UNET, the noise scheduler, and the inferer used for training and sampling. We are using
