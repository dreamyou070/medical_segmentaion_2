...
#
# This tutorial illustrates how to use MONA for training a Vector Quantized Generative Adversarial Network (VQGAN) on 2D images.
#
#
# ## Setup environment
...
# At this step, we instantiate the MONA components to create a VQVAE and a Discriminator model. We are using the
