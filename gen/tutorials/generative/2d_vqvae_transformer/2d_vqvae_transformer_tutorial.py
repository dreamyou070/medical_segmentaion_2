...
#
# This tutorial illustrates how to use MONA for training a Vector Quantized Variational Autoencoder (VQVAE)[1,2] and a transformer model on 2D images.
#
...
#
# We will work with the [MedNIST dataset](https://docs.monai.io/en/stable/apps.html#monai.apps.MedNISTDataset) available on MONA. In order to train faster, we will select just one of the available classes ("HeadCT"), resulting in a training set with 7999 2D images.
#
