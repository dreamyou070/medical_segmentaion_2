...
def main(args):
    ...
    save_base_dir = r'/share0/dreamyou070/dreamyou070/MultiSegmentation/result/medical/leader_polyp/bkai-igh-neopolyp/up_16_32_64/14_segment_image_condition_light_decoder_use_noise_pred_loss'
    lora_dir = os.path.join(save_base_dir, 'model/lora-000121.safetensors') # visual encoder freeze
    segmentation_dir = os.path.join(save_base_dir, 'segmentation/segmentation-000121.pt')
    network = load_file(lora_dir)
    segmentation_head = load_file(segmentation_dir)
    ...
    print(f' except visual transformer training')
