...
#
from data.dataset_depth import call_test_dataset_depth
...
def evaluation_check(segmentation_head,
        ...
        for _data_name in folders:
            ...
            # [2] dataloader
            test_dataloader = call_test_dataset_depth(args, _data_name, depth_processor)
            ...
            with torch.no_grad():
                ...
                for step, batch in enumerate(test_dataloader):
                    ...
                    if args.save_image :
                        ...
                        gt_pil = torch_to_pil(gt.squeeze().detach().cpu(), binary=True).resize((r, r))
