...
from utils.loss import Multiclass_FocalLoss
...
def main(args):
    ...
    if args.use_position_embedder:
        position_embedder = AllPositionalEmbedding(use_context_info = args.use_context_info,
    ...
    if args.use_position_embedder :
        segmentation_head, position_embedder, unet, text_encoder, network, optimizer, train_dataloader, test_dataloader, lr_scheduler = \
            accelerator.prepare(
        segmentation_head, position_embedder, unet, text_encoder, network, optimizer, train_dataloader, test_dataloader, lr_scheduler)
    else :
...
if __name__ == "__main__":
    ...
    parser.add_argument("--use_pe_only_cross", action = 'store_true')
    parser.add_argument("--use_pe_crossself", action='store_true')
    ...
    parser.add_argument("--use_context_info", action='store_true')
