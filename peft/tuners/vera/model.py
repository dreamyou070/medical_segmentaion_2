...
from peft_origin.tuners.tuners_utils import BaseTuner, BaseTunerLayer, check_target_module_exists
from peft_origin.utils import (
...
class VeraModel(BaseTuner):
    ...
    Example:
        ...
        >>> from peft_origin import VeraConfig, get_peft_model
