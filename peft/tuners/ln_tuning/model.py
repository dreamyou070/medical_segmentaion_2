...
from peft_origin.config import PeftConfig
from peft_origin.tuners.tuners_utils import BaseTuner, _get_submodules, check_target_module_exists
from peft_origin.utils import TRANSFORMERS_MODELS_TO_LNTUNING_TARGET_MODULES_MAPPING, ModulesToSaveWrapper
...
class LNTuningModel(BaseTuner):
    ...
    Example:
        ...
        >>> from peft_origin import get_peft_model, TaskType, LNTuningConfig
