...
class LoraModel(BaseTuner):
    ...
    Example:
        ...
        >>> from peft_origin import LoraModel, LoraConfig
        ...
        >>> import torch
        >>> import transformers
        >>> from peft_origin import LoraConfig, PeftModel, get_peft_model, prepare_model_for_kbit_training
    ...
    **Attributes**:
    ...
    def _create_and_replace(
        ...
        from peft_origin.tuners.adalora import AdaLoraLayer
    ...
    def merge_and_unload(
        ...
        >>> peft_model_id = "smangrul/falcon-40B-int4-peft_origin-lora-sfttrainer-sample"
