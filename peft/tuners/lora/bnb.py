...
from peft_origin.import_utils import is_bnb_4bit_available, is_bnb_available
from peft_origin.tuners.tuners_utils import BaseTunerLayer, check_adapters_to_merge
from peft_origin.utils.integrations import dequantize_bnb_weight
from peft_origin.utils.other import transpose
