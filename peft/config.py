...
class PeftConfigMixin(PushToHubMixin):
    ...
    Args:
        peft_type (Union[[`~peft_origin.utils.config.PeftType`], `str`]): The type of Peft method to use.
    """
    ...
    def from_peft_type(cls, **kwargs):
        ...
        from peft_origin.mapping import PEFT_TYPE_TO_CONFIG_MAPPING
        ...
        # from peft_origin import AdaLoraConfig, PeftConfig
...
class PeftConfig(PeftConfigMixin):
    ...
    Args:
        peft_type (Union[[`~peft_origin.utils.config.PeftType`], `str`]): The type of Peft method to use.
        task_type (Union[[`~peft_origin.utils.config.TaskType`], `str`]): The type of task to perform.
