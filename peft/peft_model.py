    ...
    **Attributes**:
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            save_embedding_layers (`Union[bool, str]`, *optional*, defaults to `"auto"`):
                ...
                embedding layers `peft_origin.utils.other.EMBEDDING_LAYER_NAMES` in config's `target_modules` when available.
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            is_trainable (`bool`, *optional*, defaults to `False`):
                ...
                used for inference.
            config ([`~peft_origin.PeftConfig`], *optional*):
    ...
    def add_adapter(self, adapter_name: str, peft_config: PeftConfig) -> None:
        ...
        if peft_config.peft_type != self.peft_type:
            raise ValueError(
                f"Cannot combine adapters with different peft_origin types. "
    ...
    def get_layer_status(self) -> list[TunerLayerStatus]:
        ...
        Returns:
            list[`peft_origin.peft_model.TunerLayerStatus`]:
    ...
    def get_model_status(self) -> TunerModelStatus:
        ...
        Returns:
            `peft_origin.peft_model.TunerModelStatus`:
    ...
    def create_or_update_model_card(self, output_dir: str):
        """
        Updates or create model card to include information about peft_origin:
        1. Adds `peft_origin` library tag
        2. Adds peft_origin version
        ...
        card.data["library_name"] = "peft_origin"
...
class PeftModelForSequenceClassification(PeftModel):
    ...
    **Attributes**:
    ...
    Example:
        ...
        >>> from peft_origin import PeftModelForSequenceClassification, get_peft_config
...
class PeftModelForCausalLM(PeftModel):
    ...
    Example:
        ...
        >>> from peft_origin import PeftModelForCausalLM, get_peft_config
...
class PeftModelForSeq2SeqLM(PeftModel):
    ...
    Example:
        ...
        >>> from peft_origin import PeftModelForSeq2SeqLM, get_peft_config
...
class PeftModelForTokenClassification(PeftModel):
    ...
    **Attributes**:
    ...
    Example:
        ...
        ```py
        >>> from transformers import AutoModelForSequenceClassification
        >>> from peft_origin import PeftModelForTokenClassification, get_peft_config
...
class PeftModelForQuestionAnswering(PeftModel):
    ...
    **Attributes**:
    ...
    Example:
        ...
        >>> from peft_origin import PeftModelForQuestionAnswering, get_peft_config
...
class PeftModelForFeatureExtraction(PeftModel):
    ...
    **Attributes**:
    ...
    Example:
        ...
        >>> from peft_origin import PeftModelForFeatureExtraction, get_peft_config
